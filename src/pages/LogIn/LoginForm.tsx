    ...
    <Stack minH={"100vh"} direction={{ base: "column", md: "row" }}>
      ...
      <Flex flex={1} bg="purple.700" align={"center"} justify={"center"}>
        <Box p={5} pr="7%" pl="7%" color="gray.50" alignContent="center">
          ...
          <Image src="https://images.unsplash.com/photo-1584433144859-1fc3ab64a957?q=80&w=1930&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" />

          <Text fontSize="2xl" mt="7%" mb="7%">
            Accede facilmente a tus contraseñas, tarjetas, y crea notas privadas
