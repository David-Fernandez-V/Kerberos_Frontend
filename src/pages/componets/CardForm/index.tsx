...
function CardForm({isOpen, onClose}: Props) {
    ...
    const { register, handleSubmit, setValue, formState: { errors }, setError, reset } = useForm<cardForm>({
                  ...
                  <form id="cardForm" onSubmit={handleSubmit(onSubmit)}>
                      ...
                      <Feature title="Datos de la tarjeta">
                        ...
                        <FormLabel>Número</FormLabel>
                          ...
                          />
                          {errors?.number?.message && (<Text color={"red.600"}>{errors?.number?.message}</Text>)}
                        </FormControl>
                        ...
                        <HStack>
                          <FormControl id="expiration_month">
                            ...
                            {errors?.expiration_month?.message && (<Text color={"red.600"}>{errors?.expiration_month?.message}</Text>)}
                          </FormControl>
